...
if os.getenv('AWS_LAMBDA_FUNCTION_NAME'):
    # Use mock database for Lambda deployment
    from .database_mock import *
    logger.info("Using mock database for Lambda environment")
else:
    # Use real database for local development
    try:
        import psycopg2
        ...
        from .database_mock import *
        logger.info("psycopg2 not available, using mock database")
