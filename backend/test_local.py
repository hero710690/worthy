...
if __name__ == '__main__':
    ...
    os.environ['DATABASE_URL'] = 'postgresql://worthy_admin:WorthyApp2025!@localhost:5432/worthy'
    ...
    print("Start PostgreSQL with: docker run --name worthy-postgres -e POSTGRES_DB=worthy -e POSTGRES_USER=worthy_admin -e POSTGRES_PASSWORD=WorthyApp2025! -p 5432:5432 -d postgres:15")
