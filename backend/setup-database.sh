...
echo "docker run --name worthy-postgres -e POSTGRES_DB=worthy -e POSTGRES_USER=worthy_admin -e POSTGRES_PASSWORD=WorthyApp2025! -p 5432:5432 -d postgres:15"
...
echo "    --master-user-password 'WorthyApp2025!' \\"
...
echo "DATABASE_URL=postgresql://worthy_admin:WorthyApp2025!@your-db-endpoint:5432/worthy"
